<div class="schedules index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('schedule_message_id'); ?></th>
			<th><?php echo $this->Paginator->sort('interval_months'); ?></th>
			<th><?php echo $this->Paginator->sort('last_distribution'); ?></th>
			<th><?php echo $this->Paginator->sort('next_distribution'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($schedule['Schedule']['interval_months']); ?>&nbsp;</td>
		<td><?php echo h($schedule['Schedule']['last_distribution']); ?>&nbsp;</td>
		<td><?php echo h($schedule['Schedule']['next_distribution']); ?>&nbsp;</td>
		<td class="actions">
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Back'), array('controller' => 'messages', 'action' => 'index')); ?> </li>
	</ul>
</div>
